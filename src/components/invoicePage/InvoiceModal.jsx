...
/**
 * Renders an invoice modal that displays invoice information, items,
 * and options to download or add a new invoice.
 *
 * @param {Object} props - The props object.
 * @param {boolean} props.isOpen - Determines if the modal is visible.
 * @param {function} props.setIsOpen - A function to set the modal's visibility.
 * @param {Object} props.invoiceInfo - An object containing the invoice's information.
 * @param {Array} props.items - An array of objects representing items in the invoice.
 * @param {function} props.onAddNextInvoice - A function that adds a new invoice.
 * @return {JSX.Element} Returns a JSX element containing the InvoiceModal component.
 */
const InvoiceModal = ({
  isOpen,
  setIsOpen,
