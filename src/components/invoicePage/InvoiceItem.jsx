...
/**
 * Creates an invoice item component.
 *
 ...
 * @param {function} props.onDeleteItem - The function to call when the item is deleted.
 * @param {function} props.onEdtiItem - The function to call when the item is edited.
 * @return {JSX.Element} - The invoice item component.
 */
